                ...
                <form onSubmit={handleSubmit}>
                    <div className="row">
                        ...
                        <div className="col-6 mb-3">
                            ...
                            <textarea className="form-control shadow p-3 mb-3 bg-body rounded" id="exampleFormControlTextarea1" rows="3"></textarea>
                        </div>
                    </div>
                        ...
                        <div className="col-6">
                            ...
                            <section className="row">
                                <div className='col'>
                                    ...
                                    <input className="form-control shadow p-3 mb-3 bg-body rounded" list="datalistOptions" id="exampleDataList" placeholder="Type to search..." />
                                ...
                                <div className='col'>
                                    ...
                                    <input type="number" className="form-control shadow p-3 mb-3 bg-body rounded" id="exampleFormControlInput1" placeholder="0" />
                                </div>
